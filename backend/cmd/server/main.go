...
func main() {
	...
	// membership changes — zoning while raiding would otherwise leave the
	// snapshot on a stale (or zero, if the raid arrived before the first
	// player tick) zone and encounter detection would never fire.
