...
function TimerRow({
  ...
  // remaining-time/category color, matching the in-app dashboard preview.
  const color = timer.bar_color || barColor(timer.remaining_seconds, timer.duration_seconds, timer.category)
