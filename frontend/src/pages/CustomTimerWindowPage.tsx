...
function TimerRow({
  ...
  // the fill bar), so suppressing just showUrgentColor isn't enough for the
  // countdown digits, which otherwise inherit that same red straight from
  // `color`. timeColor is the countdown-specific override: white while
  // urgent text is suppressed, `color` the rest of the time (never red when
  // not urgent).
